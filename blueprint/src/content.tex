\section{The doubling graph: an unbounded diffusion operator at finite backward length}\label{app:doubling}
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_irreducible}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_phase}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_invariant_measure}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_constant_determined}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_constant_functional}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_sigmaBar_eq}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_sigmaBar_le}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_unbounded}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_unbounded_infty}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_unbounded_two}\leanok
...
\begin{theorem}
  \label{thm:main_rate}
  \lean{GFNBounds.Doubling.main_rate}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_unsolvable}\leanok
Let $\varepsilon_{c,s}$ be a member of the family with $c>0$, $s\geq0$, and let $\lambda$ be an
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_truncation_irreducible}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_truncation_bhat}\leanok
...
\begin{theorem}
  ...
  \lean{GFNBounds.Doubling.main_truncation_sqrtK}\leanok
